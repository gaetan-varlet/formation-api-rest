...
- dans la méthode Java, il faut passer par le `principal` pour récupérer le jeton et non par l'`accessToken` car on ne peut injecter l'idep dans les tests que dans le principal et pas dans l'accessToken
