...
- pour démarrer Keycloak, se placer dans le dossier Keycloak et lancer la commande `./standalone.sh`. Keycloak est accessible à l'URL `http://localhost:8080/` ou `https://localhost:8443/`
...
- création d'un client : **localhost-frontend**
- création d'un rôle : **ADMIN_FORMATION**
- création d'un utilisateur : **toto** avec mdp **toto**
