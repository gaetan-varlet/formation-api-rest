...
## Mise à jour de la méthode configure(SpringApplicationBuilder application)

Prise en compte du fichier **formation.properties** par Spring à l'extérieur du WAR :
