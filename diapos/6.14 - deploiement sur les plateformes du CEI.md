...
- au final, on a un zip nommé **formation-api-2.0.0.zip** (si le numéro de version est 2.0.0) avec le war nommé FORMATION.war, le fichier de properties pour la prod, le fichier log4j2-cei.xml
