...
## Ajout d'une classe de conf pour logguer les properties (1)
...
## Ajout d'une classe de conf pour logguer les properties (2)
...
## Ajout d'une classe de conf pour logguer les properties (3)
