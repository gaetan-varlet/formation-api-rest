# Spring Boot : Zoom sur les principales annotations
...
- par défaut le paramètre à la même nom que la variable Java. Si on veut préciser un nom différent pour le paramètre de requpete, il faut le préciser dans l'attribut **value**
```java
